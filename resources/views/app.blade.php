            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="pull-left" href="{{ url('/') }}"><img src="{{ asset('img/logo.png') }}" /></a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                ...
                                <a href="{{ url('/auth/top') }}"><span class= "glyphicon glyphicon-star-empty" aria-hidden="true">Top</span> </a>


                            </li>
                            <li>

                                <a href="{{ url('/auth/miArbol') }}">    <span class= "glyphicon glyphicon-tree-conifer" aria-hidden="true">MiArbol </span></a>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="{{ url('/users/'.Auth::user()->slug) }}">Perfil</a></li>
